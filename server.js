    ...
    try {
        ...
        if (isTrainingFeedback) {
            ...
            feishuFields = {
                ...
                '开发经验': data['开发经验'],
                '功能类型': Array.isArray(data['功能类型']) && data['功能类型'].length > 0 ? data['功能类型'] : ['未填写'],
                '主要帮助': Array.isArray(data['主要帮助']) && data['主要帮助'].length > 0 ? data['主要帮助'] : ['未填写'],
                '困难问题': Array.isArray(data['困难问题']) && data['困难问题'].length > 0 ? data['困难问题'] : ['未填写'],
                '关注方向': Array.isArray(data['关注方向']) && data['关注方向'].length > 0 ? data['关注方向'] : ['未填写'],
                '学习形式': data['学习形式'] || '未填写',
                '学习时间': data['学习时间'] || '未填写',
                '整体满意度': data['整体满意度'],
                '是否推荐': data['是否推荐'],
